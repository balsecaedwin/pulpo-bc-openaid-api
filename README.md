...
```bash
pulpo-bc-openaid-api$ sam logs -n HelloLambdaFunction --stack-name pulpo-bc-openaid-api --tail
```
...
```bash
pulpo-bc-openaid-api$ npm install
pulpo-bc-openaid-api$ npm run test
```
...
```bash
aws cloudformation delete-stack --stack-name pulpo-bc-openaid-api
```
